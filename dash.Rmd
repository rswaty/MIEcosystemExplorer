...
What patterns do you see?  This map represents where we think the major ecosystems of Michigan would have been just prior to European settlement.  In general ecologists first figured out what drives these ecosystems to occur where they occur in terms of soil types, climate, geology and elevation.  Then they used datasets that represent those factors to predict where the ecosystems would have been.  For example, if an ecosystem was know to occur on well drained infertile soils in the coldest parts of the state, ecologists would look for those areas to place that ecosystem (*way oversimplified*!) At this time native Americans were managing the vegetation, largely through fire.  Another thing to explore: [Native Land Digital's map of indigenous territories](https://native-land.ca/){target='blank'}.  
...
Remember me asking about historical disturbances like fire?  Explore this [chord diagram](distChord .html){target='blank'} and do a little addtion noting that I think that the acres of fire (for example) depicted in the chord diagram are impressive, the are low.  I am certain there was more fire, and definitely more insect damage.  Want to help me improve the models we used?  Data from the ["Biophysical Settings" Models developed by LANDFIRE.](https://www.landfire.gov/bps-models.php){target='blank'}
...
To explore conversion for the coterminous (what does *that* mean?) United States, explore this [web app](https://randy-swaty.shinyapps.io/EcosystemExplorerRS/){target='blank'} developed by a native of Marquette, MI Mathurin Gagnon (big data-this may take a few moments to load).
